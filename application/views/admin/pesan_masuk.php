        ...
        <div class="container-fluid main-nav clearfix">
          <div class="nav-collapse">
            <ul class="nav">
              ...
              <li>
                <a class="current" href="pesanmasuk"><span aria-hidden="true" class="se7en-envelope"></span>Pesan Masuk</a>
              </li>
              <li>
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="widget-container fluid-height clearfix">
              <div class="heading">
                <a href="#"><i class="icon-plus"></i>Tulis Pesan</a>
              </div>
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <?php echo anchor('admin/detailpesan/'.$p['pesan_id'],'Detail',array('class'=>'btn btn-warning btn-xs')); ?> |
                          <?php echo anchor('admin/editpesan/'.$p['pesan_id'],'Edit',array('class'=>'btn btn-primary btn-xs')); ?> |
                          <?php echo anchor('admin/hapuspesan/'.$p['pesan_id'],'Hapus',array('class'=>'btn btn-danger btn-xs')); ?>
                        </td>
                      </tr>
                        <?php $no++; endforeach; ?>
                      <?php endif; ?>
