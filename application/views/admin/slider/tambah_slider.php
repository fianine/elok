        ...
        <div class="container-fluid main-nav clearfix">
          <div class="nav-collapse">
            <ul class="nav">
              ...
              <li>
                <a class="current" href="slider"><span aria-hidden="true" class="icon-picture"></span>Slider</a>
              </li>
              <li>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="widget-container fluid-height clearfix">
              <div class="heading">
                <i class="icon-reorder"></i>Post Slider
              </div>
              <div class="widget-content padded">
                <?php echo form_open_multipart('admin/postslider',array('class'=>'form-horizontal')); ?>
                <div class="form-group">
                  <label class="control-label col-md-2">Nomor Urut Slider</label>
                  <div class="col-md-2">
                    <input class="form-control" placeholder="Nomor Urut Slider" name="active" type="text">
                  </div>
                </div>
                  <div class="form-group">
                    <label class="control-label col-md-2">Judul Slider</label>
                    <div class="col-md-4">
                      <input class="form-control" placeholder="Judul Slider" name="judul_slider" type="text">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-md-2">Gambar Slider</label>
                    <div class="col-md-4">
                      <div class="fileupload fileupload-new" data-provides="fileupload">
                        <input type="file" class="btn btn-default btn-file fileupload-new" name="gambar_slider">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
