        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="widget-container fluid-height clearfix">
              <div class="heading">
                <a href="tambahslider"><i class="icon-plus"></i>Post Slider</a>
              </div>
              <div class="widget-content padded clearfix">
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      <?php if($showS): ?>
                        <?php $no=1; foreach($showS as $p): ?>
                      <tr>
                        <td><?php echo $no; ?></td>
                        <td><?php echo $p['judul_slider'] ?></td>
                        <td><?php echo $p['active'] ?></td>
                        <td>
                            <?php echo anchor('admin/detailslider/'.$p['slider_id'],'Detail',array('class'=>'btn btn-warning btn-xs')); ?> |
                            <?php echo anchor('admin/editslider/'.$p['slider_id'],'Edit',array('class'=>'btn btn-primary btn-xs')); ?> |
                            <?php echo anchor('admin/hapusslider/'.$p['slider_id'],'Hapus',array('class'=>'btn btn-danger btn-xs')); ?>
                        </td>
                      </tr>
                        <?php $no++; endforeach; ?>
                      <?php endif; ?>
