        ...
        <div class="container-fluid main-nav clearfix">
          <div class="nav-collapse">
            <ul class="nav">
              ...
              <li>
                <a class="current" href="<?php echo base_url() ?>admin/portofolio"><span aria-hidden="true" class="se7en-gallery"></span>Portofolio</a>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div class="col-lg-12">
            <div class="widget-container fluid-height clearfix">
              ...
              <div class="widget-content padded">
                <?php echo form_open_multipart('admin/updateporto',array('class'=>'form-horizontal')); ?>
                  <div class="form-group">
                    <label class="control-label col-md-2">Judul Portofolio</label>
                    <div class="col-md-4">
                      <input type="hidden" name="id" value="<?php echo $getEditData['porto_id'] ?>" />
                      <input type="hidden" name="gbr" value="<?php echo $getEditData['gambar_porto']; ?>" />
                      <input class="form-control" placeholder="Judul Portofolio" name="judul_porto" type="text" value="<?php echo $getEditData['judul_porto'] ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-md-2">Tagline</label>
                    <div class="col-md-5">
                      <input class="form-control" placeholder="Tagline" name="tagline" type="text" value="<?php echo $getEditData['tagline'] ?>">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
                      <div class="fileupload fileupload-new" data-provides="fileupload">
                        <img src="<?php echo base_url() ?>public/assets/upload/portofolio/<?php echo $getEditData['gambar_porto'] ?>" style="width: 87px;">&nbsp;&nbsp;
