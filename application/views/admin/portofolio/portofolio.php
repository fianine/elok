        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="widget-container fluid-height clearfix">
              <div class="heading">
                <a href="tambahportofolio"><i class="icon-plus"></i>Post Portofolio</a>
              </div>
              <div class="widget-content padded clearfix">
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      <?php if($show): ?>
                        <?php $no=1; foreach($show as $p): ?>
                      <tr>
                        <td><?php echo $no; ?></td>
                        <td><?php echo $p['judul_porto'] ?></td>
                        <td><?php echo $p['tagline'] ?></td>
                        <td><?php echo $p['kategori'] ?></td>
                        <td><?php echo $p['created_time'] ?></td>
                        <td><?php echo $p['created_date'] ?></td>
                        <td>
                            <?php echo anchor('admin/detailporto/'.$p['porto_id'],'Detail',array('class'=>'btn btn-warning btn-xs')); ?> |
                            <?php echo anchor('admin/editporto/'.$p['porto_id'],'Edit',array('class'=>'btn btn-primary btn-xs')); ?> |
                            <?php echo anchor('admin/hapusporto/'.$p['porto_id'],'Hapus',array('class'=>'btn btn-danger btn-xs')); ?>
                        </td>
                      </tr>
                        <?php $no++; endforeach; ?>
                      <?php endif; ?>
